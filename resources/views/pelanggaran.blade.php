...
<body class="bg-slate-200">
    ...
    <div class="mt-4 bg-white rounded-xl p-4 container mx-auto">
        <div class="text-xl font-semibold" mb-3>KODE AKSI PELANGARAN : {{ $kode_aksi }}</div>
        @if ($aksi == null)
        ...
        @else
            ...
            <form action="{{ route('pelanggaran.print') }}" method="POST">
                ...
                <button type="submit"
                    class="text-white mb-10 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ">Cetak</button>
            </form>
